...
var describeReduxForm = function describeReduxForm(name, structure, combineReducers, expect) {
  ...
  describe(name, function () {
    ...
    it('should provide the correct props', function () {
      ...
      expect(Object.keys(props).sort()).toEqual(['anyTouched', 'array', 'asyncValidate', 'asyncValidating', 'autofill', 'blur', 'change', 'clearSubmit', 'destroy', 'dirty', 'dispatch', 'error', 'form', 'handleSubmit', 'initialValues', 'initialize', 'initialized', 'invalid', 'pristine', 'pure', 'reset', 'submit', 'submitFailed', 'submitSucceeded', 'submitting', 'touch', 'triggerSubmit', 'untouch', 'valid', 'warning']);
    ...
    it('should not reinitialize values on remount if destroyOnMount is false', function () {
      ...
      var Container = function (_Component37) {
        _inherits(Container, _Component37);

        function Container() {
          _classCallCheck(this, Container);

          var _this48 = _possibleConstructorReturn(this, (Container.__proto__ || Object.getPrototypeOf(Container)).call(this));

          _this48.state = { showForm: true };
          return _this48;
        }
          ...
          value: function render() {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                'button',
                { onClick: function onClick() {
                    return _this49.setState({ showForm: !showForm });
                  } },
                'Toggle Form'
              )
            );
